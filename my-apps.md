...
## **Mew Scale Server**: Networking and Authenication
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/rickroll.png" width="48" height="36" /> | **rickroll** | ⚠️ | Self-hosted Rickrolls. Image is based on Nginx stable alpine, and all the content is local to the Chart. |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/blocky.png" width="48" height="36" /> | **blocky** | 👔 | Blocky is a DNS proxy, DNS enhancer and ad-blocker for the local network written in Go |
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/cert-manager.png" width="48" height="36" /> | **cert-manager** | 👔 | Certificate management for Kubernetes |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/fileflows.png" width="48" height="36" /> | **fileflows** | ✅ | An application that lets you automatically process files through a simple rule flow. |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/muse.png" width="48" height="36" /> | **muse** | ⚠️ | A self-hosted midwestern Discord music bot that doesn't suck. |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/openbooks.png" width="48" height="36" /> | **openbooks** | ⚠️ | IRC Highway eBook Downloads. |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/plexripper.png" width="48" height="36" /> | **plexripper** | ⚠️ | PlexRipper is a cross-platform media downloader that indexes the Plex servers you have access to and allows you to download everything while adding it to your own Plex server. |
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/prometheus.png" width="48" height="36" /> | **prometheus** | 👔 | kube-prometheus-stack collects Kubernetes manifests, Grafana dashboards, and Prometheus rules combined with documentation and scripts to provide easy to operate end-to-end Kubernetes cluster monitoring with Prometheus using the Prometheus Operator. |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/recyclarr.png" width="48" height="36" /> | **recyclarr** | ✅ | A command-line application that will automatically synchronize recommended settings from TRaSH guides to your Sonarr/Radarr instances. |
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/redis.png" width="48" height="36" /> | **redis** | 🔨 | Open source, advanced key-value store. |
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/redisinsight.png" width="48" height="36" /> | **redisinsight** | ⚠️ | GUI for Redis. |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/scrutiny.png" width="48" height="36" /> | **scrutiny** | ✅ | Scrutiny WebUI for smartd S.M.A.R.T monitoring. Scrutiny is a Hard Drive Health Dashboard & Monitoring solution. |
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/snippet-box.png" width="48" height="36" /> | **snippet-box** | ⚠️ | Snippet Box is a simple self-hosted app for organizing your code snippets. It allows you to easily create, edit, browse and manage your snippets in various languages. |
